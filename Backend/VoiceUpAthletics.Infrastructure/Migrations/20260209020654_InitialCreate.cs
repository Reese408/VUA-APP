        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntraTenantId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    AllowAnonymousReports = table.Column<bool>(type: "bit", nullable: false),
                    RequireStaffApproval = table.Column<bool>(type: "bit", nullable: false),
                    MaxReportsPerDay = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnmaskedUserId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UnmaskingReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailabilityHours = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnonymousAlias = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    ReportsSubmittedToday = table.Column<int>(type: "int", nullable: false),
                    LastReportSubmittedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubmittedByAnonymousId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Category = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    IncidentDate = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IncidentLocation = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    InvolvedParties = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reports_UserProfiles_AssignedToUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_UserProfiles_SentByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_UnmaskedUserId",
                table: "AuditLogs",
                column: "UnmaskedUserId",
                filter: "[UnmaskedUserId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_IsEscalated",
                table: "Reports",
                column: "IsEscalated");

            migrationBuilder.CreateIndex(
                name: "IX_Reports_IsFlagged",
                table: "Reports",
                column: "IsFlagged");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_SubmittedByAnonymousId",
                table: "Reports",
                column: "SubmittedByAnonymousId");

            migrationBuilder.CreateIndex(
                name: "IX_Reports_TenantId_Status_CreatedAt",
                table: "Reports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_DisplayOrder",
                table: "Resources",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_IsEmergency",
                table: "Resources",
                column: "IsEmergency");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_AnonymousId",
                table: "UserProfiles",
                column: "AnonymousId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_EntraObjectId_TenantId",
                table: "UserProfiles",
